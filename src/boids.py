...
class Boid(pg.sprite.Sprite):
    def __init__(self, id, drawSurf, cHSV=None):
        ...
        self.rect = self.image.get_rect(
            center=(randint(50, dS_w - 50), randint(50, dS_h - 50)))
...
def main():
    ...
    while running:
        ...
        for boid in nBoids.sprites():
            [x, y, a] = boid.getParams()
            dataWriter.writeBoidData(x, y, a)
